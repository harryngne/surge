...
const DEFAULT_OPTIONS = {
    ...
    fullContent: 'Hỗ trợ đầy đủ Netflix，Khu vực：#REGION_FLAG# #REGION_NAME#',
    fullIcon: '',
    fullIconColor: '',
    fullStyle: 'good',
    onlyOriginalContent: 'Chỉ hỗ trợ phim truyền hình tự sản xuất trong khu vực：#REGION_FLAG# #REGION_NAME#',
    onlyOriginalIcon: '',
    onlyOriginalIconColor: '',
    onlyOriginalStyle: 'info',
    notAvailableContent: 'Không hỗ trợ Netflix',
    notAvailableIcon: '',
    notAvailableIconColor: '',
    notAvailableStyle: 'alert',
    errorContent: 'Kiểm tra không thành công, vui lòng thử lại',
    errorIcon: '',
    errorIconColor: '',
    errorStyle: 'error',
}
