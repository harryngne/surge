...
const DEFAULT_OPTIONS = {
    title: 'Kiểm tra mở khóa Netflix',
    fullContent: '完整支持Netflix，地区：#REGION_FLAG# #REGION_NAME#',
    fullIcon: '',
    fullIconColor: '',
    fullStyle: 'good',
    onlyOriginalContent: 'Chỉ hỗ trợ phim truyền hình tự sản xuất，Khu vực：#REGION_FLAG# #REGION_NAME#',
    onlyOriginalIcon: '',
