...
if (!v4.primaryAddress && !v6.primaryAddress) {
    $done({
        title: 'Không kết nối mạng',
        content: 'Thiết bị không kết nối mạng\nVui lòng kiểm tra lại trạng thái mạng và thử lại',
    ...
    $httpClient.get('http://ip-api.com/json', function(error, response, data) {
        ...
        $done({
            ...
            content:
                ...
                `Nhà cung cấp ISP : ${info.isp}\n` +
                `Vị trí IP : ${getFlagEmoji(info.countryCode)} | ${info.country} - ${info.city
        }`,
