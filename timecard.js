...
const calendar = {
         ...
         */
        festival: {
            '1-1': { title: 'Ngày đầu năm' },
            '2-14': { title: 'Lễ tình nhân' },
            '5-1': { title: 'Ngày lao động' },
            '5-4': { title: 'Tuổi trẻ' },
            '6-1': { title: 'Ngày trẻ em' },
            '9-10': { title: 'Ngày nhà giáo' },
            '09-2': { title: 'Ngày quốc khánh' },
            '12-25': { title: 'Giáng sinh' },

            '3-8': { title: 'Ngày phụ nữ' },
            '3-12': { title: 'Ngày lễ trồng cây' },
            '4-1': { title: 'Ngày cá tháng tư' },
            '5-12': { title: 'Ngày y tá' },
            '7-1': { title: 'Ngày tiệc tùng' },
            '8-1': { title: 'Ngày quân đội' },
            '12-24': { title: 'Đêm giáng sinh' },
        },
        ...
        lFestival: {
            ...
            '1-1': { title: 'Lễ hội xuân' },
            '1-15': { title: 'Lễ hội đèn lồng' },
            '2-2': { title: 'Rồng nhìn lên' },
            '5-5': { title: 'Lễ hội thuyền rồng' },
            '7-7': { title: 'Lễ hội Qixi' },
            '7-15': { title: 'Lễ hội ma đói' },
            '8-15': { title: 'Ngày trung thu' },
            '9-9': { title: 'Lễ hội đôi lần thứ chín' },
            '10-1': { title: 'Lễ hội quần áo lạnh' },
            '10-15': { title: 'Lễ hội nhân dân tệ' },
            '12-8': {
                title: 'Lễ hội laba },
                '12-23': { title: 'Bắc tiểu niên' },
                '12-24': { title: 'Nam Tiểu niên' },
            },
        ...
        var nowsolar = lunar.cMonth + ' Tháng' + lunar.cDay + ' Ngày';
        //var nowlunar = lunar.lYear + '年' +lunar.IMonthCn+lunar.IDayCn+'，'+lunar.gzYear+'年'+lunar.gzMonth+'月'+lunar.gzDay+'日（'+lunar.Animal+'年）';
        var nowlunar = lunar.IMonthCn + lunar.IDayCn + ' ' + lunar.gzYear + lunar.gzMonth + lunar.gzDay + ' ' + lunar.Animal + 'Năm';
